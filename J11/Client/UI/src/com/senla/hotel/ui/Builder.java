...
public class Builder implements IBuilder {
	...
	public static IBuilder getInstance() {
		if (instance == null) {
	...
	/* (non-Javadoc)
	 * @see com.senla.hotel.ui.IBuilder#getRootMenu()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.senla.hotel.ui.IBuilder#buildMenu()
	 */
	@Override
	public void buildMenu() {
		// print & choose rooms
		IMenu sortRoomsSubMenu = new Menu();
		IMenu afterPrintRoomSubMenu = new Menu();
		IMenu roomSubMenu = new Menu();
		IMenu addRoomSubMenu = new Menu();
		// free rooms
		IMenu sortFreeRoomsSubMenu = new Menu();
		IMenu afterPrintFreeRoomSubMenu = new Menu();

		// print & choose clients
		IMenu addClientSubMenu = new Menu();
		IMenu clientSubMenu = new Menu();
		IMenu sortClientSubMenu = new Menu();
		IMenu afterPrintClientSubMenu = new Menu();
		IMenu selectRoomToAddOrderSubMenu = new Menu();
		IMenu addServiceToClientSubMenu = new Menu();


		// print & choose orders
		IMenu sortOrderSubMenu = new Menu();
		IMenu orderSubMenu = new Menu();
		IMenu afterPrintOrderSubMenu = new Menu();
		IMenu setOrderParamsSubMenu = new Menu();
		...
		IMenu addServiceSubMenu = new Menu();
		...
		MenuItem printFreeRoomsByDate = new MenuItem("--Print free rooms internalName date", new PrintFreeRoomsInFutureAction());
		...
		MenuItem setRoomOnService = new MenuItem("--Set room internalName service", new SetRoomOnServiceAction());
