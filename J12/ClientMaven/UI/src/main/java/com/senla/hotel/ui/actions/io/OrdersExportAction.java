...
public class OrdersExportAction implements IAction {
    ...
    public void execute(ObjectOutputStream writer, ObjectInputStream reader) throws ActionForceStopException {
        try {
            Message request = new Message(FacadeAPI.EXPORT_ORDERS, null);
            writer.writeObject(request);
            reader.readObject();

            request = new Message(FacadeAPI.EXPORT_CLIENTS, null);
            writer.writeObject(request);
            reader.readObject();

            request = new Message(FacadeAPI.EXPORT_ROOMS, null);
            writer.writeObject(request);
            reader.readObject();

            request = new Message(FacadeAPI.EXPORT_SERVICES, null);
            writer.writeObject(request);
            reader.readObject();
