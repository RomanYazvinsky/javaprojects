...
public class PrintActualClientsAction implements IAction {
    private static Logger logger = LogManager.getLogger(PrintActualClientsAction.class);
    ...
    public void execute(ObjectOutputStream writer, ObjectInputStream reader) throws ActionForceStopException {
        try {
            Message request = new Message(PublicAPI.GET_ACTUAL_CLIENTS, new Object[]{new GregorianCalendar().getTime()});
