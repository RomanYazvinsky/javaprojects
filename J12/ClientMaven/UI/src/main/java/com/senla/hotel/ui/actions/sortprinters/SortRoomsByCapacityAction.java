...
public class SortRoomsByCapacityAction implements IAction {
    private static Logger logger = LogManager.getLogger(SortRoomsByCapacityAction.class);
    ...
    public void execute(ObjectOutputStream writer, ObjectInputStream reader) throws ActionForceStopException {
        try {
            ...
            request = new Message(FacadeAPI.SORT_ROOMS_BY_CAPACITY, new Object[]{rooms});
            writer.writeObject(request);
            reader.readObject();
