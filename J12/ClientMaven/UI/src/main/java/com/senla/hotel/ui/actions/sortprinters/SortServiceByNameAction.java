...
public class SortServiceByNameAction implements IAction {
    private static Logger logger = LogManager.getLogger(SortServiceByNameAction.class);
    ...
    public void execute(ObjectOutputStream writer, ObjectInputStream reader) throws ActionForceStopException {
        try {
            ...
            request = new Message(FacadeAPI.SORT_SERVICES_BY_NAME, new Object[]{services});
            writer.writeObject(request);
            reader.readObject();
