...
public interface IServiceRecordManager {
    void add(ServiceRecord serviceRecord) throws QueryFailureException, UnexpectedValueException, AnalysisException;

    void delete(ServiceRecord serviceRecord) throws QueryFailureException, AnalysisException;
