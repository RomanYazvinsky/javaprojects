...
public class Constants {
    public static final String PATH_TO_PROPERTIES = "../../ServerMaven/Properties/hotel.properties";
    public static final String PATH_TO_DATABASE_PROPERTIES = "../../ServerMaven/DBProperties/db.properties";
