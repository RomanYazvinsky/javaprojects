...
public class Filler {
	...
	public static ArrayList<Service> sra1 =  new ArrayList<>(Arrays.asList(new Service[] { sr1, sr2, sr3 }));
	public static ArrayList<Service> sra2 =  new ArrayList<>(Arrays.asList(new Service[] { sr3 }));
	public static ArrayList<Service> sra3 =  new ArrayList<>(Arrays.asList(new Service[] { sr1, sr3 }));
